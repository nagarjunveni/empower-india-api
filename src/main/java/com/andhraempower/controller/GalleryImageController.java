...
public class GalleryImageController {
    ...
    public ResponseEntity<String> uploadImage(@RequestParam("file") MultipartFile file,
        ...
        try {
            imageService.uploadImage(file, eventType, description);
    ...
    public ResponseEntity<String> uploadMultipleImages(@RequestParam("files") List<MultipartFile> files,
                                                       ...
                                                       @RequestParam("description") String description) {
        try {
            imageService.uploadImages(files, eventType, description);
    ...
    public ResponseEntity<byte[]> getImage(@PathVariable Long id) {
        Optional<GalleryImage> imageOpt = imageService.getImage(id);
    ...
    public ResponseEntity<String> softDeleteImage(@PathVariable Long id) {
        Optional<GalleryImage> imageOpt = imageService.softDeleteImage(id);
        if (imageOpt.isPresent()) {
